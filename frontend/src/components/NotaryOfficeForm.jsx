...
import { addNotary } from './backendConnectors/landConnector';

const NotaryOfficeForm = () => {
    ...
    const onSubmit = async (event) => {
        ...
        try {
            ...
            const result = await addNotary(formData);
    ...
    return (
        <Container component="main" maxWidth="xs">
            {isLoggedIn ? (<form onSubmit={onSubmit} noValidate>
                ...
                You need to be logged in to add a Notary office address.
            </Typography>)}
...
export default NotaryOfficeForm;
